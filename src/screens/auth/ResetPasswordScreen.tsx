...
const ResetPasswordScreen = ({ navigation }: any) => {
  ...
  const handleResetPassword = () => {
    // Navigating back to Login screen after password reset
    ...
    <SafeAreaView style={styles.safeArea} edges={['bottom']}>
      ...
      >
        ...
        >
          ...
          <Text style={[styles.title, { fontSize: titleFontSize, paddingHorizontal }]}>Reset Password</Text>
          ...
          <View style={[styles.inputContainer, { marginHorizontal: paddingHorizontal }]}>
            ...
            <View style={[styles.inputWrapper, { flexDirection: 'row', alignItems: 'center' }]}>
              ...
              <TouchableOpacity onPress={() => setShowConfirmPassword(!showConfirmPassword)} style={{ padding: 4 }}>
                <Icon name={showConfirmPassword ? "eye-outline" : "eye-off-outline"} size={20} color="#161D2F" />
              </TouchableOpacity>
            </View>
          </View>
